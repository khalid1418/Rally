    ...
    RallyTheme {
        ...
        Scaffold(
            ...
            NavHost(
                ...
                composable(route = "$accountName/{name}", arguments = listOf(navArgument("name") {
                    ...
                    entry ->
                    val accountNames = entry.arguments?.getString("name")
                    val account = UserData.getAccount(accountNames)
